  ...
  return (
    ...
    <div className="text-center">
      ...
      <ul className="flex flex-wrap justify-center gap-x-8 gap-4 my-8">
        ...
        <li><a href='https://x.com/_BlockDevs' className="text-xl hover:text-gray-400">
          <svg xmlns="http://www.w3.org/2000/svg" 
          className="inline w-7 h-7" viewBox="0 0 1227 1227">
      ...
      <p className="text-base">&copy; 2024<a href='https://readymadeui.com/' target='_blank'
        className="hover:underline mx-2">BlockDevs</a>All Rights Reserved.</p>
    </div>
  </footer>
  )
}
